...
data <- read.csv(file= "rq1_data.csv", header=TRUE, sep=",")
# testability_smells <- data[["TotalTestabilitySmells"]]
testability_smells <- data[["TyS_normalized"]]
# test_smells <- data[["TotalTestSmells"]]
